 ...
 *
 */
public class RunStopTimesCountToGeoHash extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		int result = ToolRunner.run(new Configuration(), new RunStopTimesCountToGeoHash(), args);
		System.exit(result);
	}
